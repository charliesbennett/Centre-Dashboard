...
export default function Dashboard() {
  ...
  const renderTab = () => {
    ...
    switch (tab) {
      ...
      case "rota": return <RotaTab staff={db.staff} progStart={progStart} progEnd={progEnd} excDays={db.excDays} groups={activeGroups} rotaGrid={db.rotaGrid} setRotaGrid={setRotaGrid} progGrid={db.progGrid} centreName={centreName} readOnly={isReadOnly} rotaStale={rotaStale} onRotaStaleCleared={() => setRotaStale(false)} settings={db.settings} saveSetting={db.saveSetting} />;
      ...
      case "transfers": return <TransfersTab groups={activeGroups} transfers={db.transfers} setTransfers={setTransfers} saveTransfer={db.saveTransfer} deleteTransfer={db.deleteTransfer} readOnly={isReadOnly} />;
      case "team": return <TeamTab staff={db.staff} setStaff={setStaff} readOnly={isReadOnly} isHeadOffice={auth.isHeadOffice} centres={db.centres} />;
