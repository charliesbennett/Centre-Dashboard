...
export default function Dashboard() {
  ...
  const renderTab = () => {
    ...
    switch (tab) {
      ...
      case "rota": return <RotaTab staff={db.staff} progStart={progStart} progEnd={progEnd} excDays={db.excDays} groups={activeGroups} rotaGrid={db.rotaGrid} setRotaGrid={setRotaGrid} progGrid={db.progGrid} readOnly={isReadOnly} />;
