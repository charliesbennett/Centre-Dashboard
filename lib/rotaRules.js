...
// Sessions = Lessons, English Test, Activities, Evening Activity, excursion names, Airport.
// Non-sessions = admin, rest (Day Off, Induction, Setup, Office).
export const NO_COUNT = new Set([
  "Day Off", "Induction", "Setup", "Office",
...
14. The following values never count as sessions: Day Off, Induction, Setup, Office, Welcome, Pickup, Departure Duty. Airport DOES count as a session.
`.trim();

// ── Session counting ───────────────────────────────────────────────────────
// rotaGrid: flat object { "staffId-dateKey-slot": value }
// noCountSet: Set of values that don't count as sessions (default: NO_COUNT)
