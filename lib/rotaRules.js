...
export const ROLE_RULES = {
  ...
  FOOTBALL: { target: 12, canTeach: false, canExcursion: true, canEvEnt: true, specialism: "Football" },
  PA:       { target: 12, canTeach: false, canExcursion: true, canEvEnt: true, specialism: "Performing Arts" },
