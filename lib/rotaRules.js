...
export const ROLE_RULES = {
  ...
  PA:       { target: 24, canTeach: false, canExcursion: true, canEvEnt: true, specialism: "Performing Arts" },
...
export const NO_COUNT = new Set(["Day Off", "Office", "Induction"]);
...
4. SAI/AL/EAL/SC/AC/EAC/LAL/LAC/FOOTBALL/PA/HP session count must NOT exceed 24 per fortnight.
...
7. Activity-only roles (SAI, AL, EAL, SC, AC, EAC, LAL, LAC, FOOTBALL, PA, HP) must NEVER have Lessons or Testing.
