...
function matchCentre(raw, centres) {
  if (!raw) return null;
  // Expand known abbreviations on the input side
  ...
  for (const c of centres) {
    // Also expand DB centre name if it is itself a known abbreviation
    ...
    // Score = proportion of words matched on both sides
