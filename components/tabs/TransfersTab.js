            ...
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 10 }}>
              <thead>
                <tr>
                  ...
                  <th style={{ ...thStyle, background: B.successBg, color: B.text }} rowSpan={2}>Arr Notes</th>
                  <th style={{ ...thStyle, background: B.dangerBg, color: B.text }} rowSpan={2}>Dep Notes</th>
                  <th style={thStyle} rowSpan={2}></th>
                </tr>
                <tr>
                  {["Airport", "Term", "Date", "Flight", "Time"].map((h) => <th key={"a"+h} style={{ ...thStyle, fontSize: 8, background: B.successBg, color: B.text }}>{h}</th>)}
                  {["Airport", "Term", "Date", "Flight", "Time"].map((h) => <th key={"d"+h} style={{ ...thStyle, fontSize: 8, background: B.dangerBg, color: B.text }}>{h}</th>)}
                </tr>
              </thead>
              <tbody>
                {transfers.length === 0 ? (
              ...
              <thead>
                <tr>
                  {["Agent", "Group", "Pax", "UKLC", "Airport", "Terminal", "Date", "Flight", "Time", "Status", "Notes", ""].map((h) => (
                    <th key={h} style={{ ...thStyle, background: B.successBg, color: B.text }}>{h}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
          ...
          <TableWrap>
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 10 }}>
              <thead>
                <tr>
                  {["Agent", "Group", "Pax", "UKLC", "Airport", "Terminal", "Date", "Flight", "Time", "Status", "Notes", ""].map((h) => (
                    <th key={h} style={{ ...thStyle, background: B.dangerBg, color: B.text }}>{h}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
