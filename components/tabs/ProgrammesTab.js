  ...
  return (<div>
    ...
    {viewMode==="all" && <div style={{padding:"0 4px 16px",overflowX:"auto"}}>
      <TableWrap><table style={{width:"100%",borderCollapse:"collapse",fontSize:10}}>
        ...
        <tbody>
          {groups.length===0?<tr><td colSpan={100} style={{textAlign:"center",padding:36,color:B.textLight}}>Import groups in Students tab to see the overview</td></tr>:
      ...
      <div style={{padding:"6px 12px",fontSize:9,color:B.textMuted}}>Double-click any cell to edit · Click date headers to toggle excursion days</div>
    </div>}
